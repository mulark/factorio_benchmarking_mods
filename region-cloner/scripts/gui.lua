...
gui.create_gui = function (player)
	...
	advanced_settings_gui.add{type="checkbox", caption="Print Progress", state=false, name=GUI_ELEMENT_PREFIX .. "progress_bar", tooltip="The progress bar spends an additional 1 tick for each copy"}
	advanced_settings_gui.add{type="checkbox", caption="Print Detailed Progress", state=false, name=GUI_ELEMENT_PREFIX .. "detailed_log", tooltip="The detailed log spends an additional 4 tick for each copy"}
