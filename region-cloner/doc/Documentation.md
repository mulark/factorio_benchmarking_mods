...
Since the majority of entites cannot be teleported between surfaces, cloning the state of the signals on a circuit network is not possible across surfaces.
